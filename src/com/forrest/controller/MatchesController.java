...
public class MatchesController {
	...
	public String updateMEvent() throws Exception {
		...
		/*
		 * 
		String rootUrlString = "https://odds.500.com/fenxi1/inc/stat_ajax.php?act=event&id=748969";
		Dictionary<String,String> dictionary = MatchesParse.getMatchesEventData(client, rootUrlString);

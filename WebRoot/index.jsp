...
<link rel="stylesheet" href="adminlte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.csss">
<link rel="stylesheet"
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="resource/images/avatar.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="resource/images/avatar.jpg" class="img-circle" alt="User Image">

                <p>
                  Forrst Woo - 初级程序员
                  <small>2010-10-11</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="userlist" target="menuFrame"><i class="fa fa-circle-o"></i>用户管理</a></li>
...
<iframe id="menuFrame" name="menuFrame" src="welcome.jsp" style="height:1000px"  scrolling="yes" frameborder="0" height="100%" width="100%"></iframe>
